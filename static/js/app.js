...
window.onload = function () {
    ...
    function vidplay(videoID, buttonID) {
        ...
        if (videoID.paused) {
            videoID.play();
            buttonID.textContent = "PAUSIEREN";
        } else {
            videoID.pause();
            buttonID.textContent = "FORTSETZEN";
        }
    };
    ...
    function vidStop(videoID, playButtonID) {
        ...
        playButtonID.textContent = "ABSPIELEN";
    };
};
